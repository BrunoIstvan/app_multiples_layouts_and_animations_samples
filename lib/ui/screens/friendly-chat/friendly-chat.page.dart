...
class FriendlyChatPage extends StatefulWidget {
  @override
  State createState() => new FriendlyChatPageState();
}

class FriendlyChatPageState extends State<FriendlyChatPage>
    with TickerProviderStateMixin {
  final List<ChatMessage> _messages = <ChatMessage>[];
  final TextEditingController _textController = new TextEditingController();
  // make it true whenever the user is typing in the input field.
