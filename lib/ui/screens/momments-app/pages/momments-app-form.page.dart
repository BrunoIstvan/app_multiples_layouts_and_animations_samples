...
class MommentsAppFormPage extends StatefulWidget {
  @override
  _MommentsAppFormPageState createState() => _MommentsAppFormPageState();
}

class _MommentsAppFormPageState extends State<MommentsAppFormPage> {
  ...
  ListTile getNameInputListTile() {
    return ListTile(
      leading: Padding(
        ...
        child: Text('Your Name:', style: Theme.of(context).textTheme.subtitle2),
      ),
      title: Padding(
  ...
  Widget getGenderOptions() {
    return ListTile(
      leading: Padding(
        ...
        child: Text('Gender:', style: Theme.of(context).textTheme.subtitle2),
      ),
      title: Row(
