...
class ProfileSample4Page extends StatefulWidget {
  @override
  _ProfileSample4PageState createState() => _ProfileSample4PageState();
}

class _ProfileSample4PageState extends State<ProfileSample4Page> {
  @override
          ...
          children: <Widget>[
            ...
            Row(
              children: <Widget>[
                ...
                SizedBox(width: 10.0),
                Text("dlohani48@gmail.com", style: TextStyle(fontSize: 16.0)),
              ],
            ),
            SizedBox(height: 10.0),
            Row(
              children: <Widget>[
                ...
                SizedBox(width: 10.0),
                Text("+977-9818523107", style: TextStyle(fontSize: 16.0)),
              ],
            ),
            _buildSocialsRow(),
            SizedBox(height: 20.0),
