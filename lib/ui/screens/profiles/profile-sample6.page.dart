...
class ProfileSample6Page extends StatefulWidget {
  ProfileSample6Page({this.dev});

  final DEV dev;
  @override
  _ProfileSample6PageState createState() => _ProfileSample6PageState();
}

class _ProfileSample6PageState extends State<ProfileSample6Page> {
  ...
  Widget _buildAvatar() {
    return Container(
      ...
      child: ClipOval(
        child: PNetworkImage(widget.dev.avatar),
      ),
    );
  }
  ...
  Widget _buildInfo() {
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          Text(
            widget.dev.firstName + widget.dev.lastName,
            style: TextStyle(
              color: Colors.white,
    ...
    return Padding(
      ...
      child: SizedBox.fromSize(
        ...
        child: ListView.builder(
          ...
          itemCount: widget.dev.videos.length,
          itemBuilder: (BuildContext context, int index) {
            var video = widget.dev.videos[index];
    ...
    return Scaffold(
      body: Stack(
        ...
        children: <Widget>[
          ...
          PNetworkImage(widget.dev.backdropPhoto, fit: BoxFit.cover),
          BackdropFilter(
