...
class AnimationPart2Sample5Page extends StatefulWidget {
  final List<BarItem> items = [
    BarItem(icon: Icons.home, title: "Home", color: Colors.indigo),
    BarItem(
        icon: Icons.favorite_border, title: "Likes", color: Colors.pinkAccent),
  ...
  @override
  _AnimationPart2Sample5PageState createState() =>
      _AnimationPart2Sample5PageState();
}

class _AnimationPart2Sample5PageState extends State<AnimationPart2Sample5Page>
  ...
  AnimatedBottomBar _buildAnimatedBottomBar() {
